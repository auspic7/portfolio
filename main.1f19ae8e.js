...
},{"process":"../../.config/yarn/global/node_modules/process/browser.js"}],"node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"node_modules/scrollmagic-plugin-gsap/index.js":[function(require,module,exports) {
/*!
...
var tween = _gsap.TweenMax.staggerTo(".fadeIn", 1, {
  autoAlpha: 1
}, 1);

_gsap.TweenMax.set(".fadeIn", {
  autoAlpha: 0
});

_gsap.TweenMax.set(".whatdev", {
  opacity: 1,
  top: 0
});

var tween_text1_fadeout = _gsap.TweenMax.staggerFromTo(".whatdev", 1, {
  top: 0,
  opacity: 1
}, {
  top: -100,
...
var tween_text2_fadeout = _gsap.TweenMax.staggerFromTo(".whatdev", 1, {
  top: 0,
  opacity: 1
}, {
  top: -100,
...
var tween_text2_fadein = _gsap.TweenMax.staggerFromTo(".whatdev", 1, {
  top: 100,
  opacity: 0
}, {
  top: 0,
...
var tween_text3_fadein = _gsap.TweenMax.staggerFromTo(".whatdev", 1, {
  top: 100,
  opacity: 0
}, {
  top: 0,
...
(0, _jquery.default)(function () {
  ...
  // build scene
  var pin = new _scrollmagic.default.Scene({
    offset: 0,
    triggerHook: 0.45,
    duration: 1000
  }).setPin("#pin1").addIndicators() // add indicators (requires plugin)
  .addTo(controller);
  var fade_image = new _scrollmagic.default.Scene({
    offset: 200,
    duration: 400
  }).setTween(tween).addIndicators().addTo(controller);
  var text1_fadeout = new _scrollmagic.default.Scene({
    offset: 200,
    duration: 200
  }).setTween(tween_text1_fadeout).addIndicators().addTo(controller).on("end", function (event) {
    if (event.scrollDirection == "FORWARD") {
      (0, _jquery.default)(".whatdev").text("파워풀한");
    }
  }).on("enter", function (event) {
    if (event.scrollDirection == "REVERSE") (0, _jquery.default)(".whatdev").text("열정적인");
  });
  var text2_fadein = new _scrollmagic.default.Scene({
    offset: 400,
    duration: 200
  }).setTween(tween_text2_fadein).addIndicators().addTo(controller);
  var text2_fadeout = new _scrollmagic.default.Scene({
    offset: 600,
    duration: 200
  }).setTween(tween_text2_fadeout).addIndicators().addTo(controller).on("end", function (event) {
    if (event.scrollDirection == "FORWARD") {
      (0, _jquery.default)(".whatdev").text("발전하는");
    }
  }).on("enter", function (event) {
    if (event.scrollDirection == "REVERSE") (0, _jquery.default)(".whatdev").text("파워풀한");
  });
  var text3_fadein = new _scrollmagic.default.Scene({
    offset: 800,
    duration: 200
  }).setTween(tween_text3_fadein).addIndicators().addTo(controller);
...
},{"jquery":"node_modules/jquery/dist/jquery.js","gsap":"node_modules/gsap/index.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js","scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators":"node_modules/scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators.js","scrollmagic-plugin-gsap":"node_modules/scrollmagic-plugin-gsap/index.js"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
